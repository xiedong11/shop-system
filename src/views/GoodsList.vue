<template>
    <div class="page-root">
        ...
        <div class="search-view">
            <input class='search-input' id='search-input' :placeholder="$t(`message.input_key_word`)"/>
            <span @click="getProductByTitle">{{$t(`message.search_by_name`)}}</span>
            <span @click="getProductByType">{{$t(`message.search_by_Type`)}}</span>
        </div>
...
<script>
    ...
    import {getAllList, getGoodsByName, getGoodsByType} from "../api/request";
